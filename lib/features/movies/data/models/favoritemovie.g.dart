...
void _favoriteMovieSerialize(
  ...
  writer.writeString(offsets[3], object.movieId);
...
FavoriteMovie _favoriteMovieDeserialize(
  ...
  object.movieId = reader.readStringOrNull(offsets[3]);
...
extension FavoriteMovieQueryWhereSort
  ...
  QueryBuilder<FavoriteMovie, FavoriteMovie, QAfterWhere> anyIsFavorite() {
    return QueryBuilder.apply(this, (query) {
...
extension FavoriteMovieQuerySortBy
  ...
  QueryBuilder<FavoriteMovie, FavoriteMovie, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FavoriteMovie, FavoriteMovie, QAfterSortBy> sortByImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.asc);
    });
  }

  QueryBuilder<FavoriteMovie, FavoriteMovie, QAfterSortBy> sortByImageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.desc);
    });
  }

  QueryBuilder<FavoriteMovie, FavoriteMovie, QAfterSortBy> sortByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
...
extension FavoriteMovieQuerySortThenBy
  ...
  QueryBuilder<FavoriteMovie, FavoriteMovie, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }
  ...
  QueryBuilder<FavoriteMovie, FavoriteMovie, QAfterSortBy> thenByImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.asc);
    });
  }

  QueryBuilder<FavoriteMovie, FavoriteMovie, QAfterSortBy> thenByImageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.desc);
    });
  }

  QueryBuilder<FavoriteMovie, FavoriteMovie, QAfterSortBy> thenByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.asc);
    });
  }
...
extension FavoriteMovieQueryWhereDistinct
  ...
  QueryBuilder<FavoriteMovie, FavoriteMovie, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FavoriteMovie, FavoriteMovie, QDistinct> distinctByImage(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FavoriteMovie, FavoriteMovie, QDistinct> distinctByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
...
extension FavoriteMovieQueryProperty
  ...
  QueryBuilder<FavoriteMovie, String?, QQueryOperations> descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'description');
    });
  }

  QueryBuilder<FavoriteMovie, String?, QQueryOperations> imageProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'image');
    });
  }

  QueryBuilder<FavoriteMovie, bool, QQueryOperations> isFavoriteProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isFavorite');
    });
  }

  QueryBuilder<FavoriteMovie, String?, QQueryOperations> movieIdProperty() {
    return QueryBuilder.apply(this, (query) {
